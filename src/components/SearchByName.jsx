...
export function SearchByName({ children }) {
  ...
  return (
      <section className="mainContainer mt-20">
           ...
           <div className="flex justify-start items-center gap-4 mb-4">
                ...
                <div className="flex flex-col justify-center gap-y-1 items-center">
                    <label className="text-lg text-center font-semibold" htmlFor="search"></label>
                        <input
                            className="w-40 md:w-60 h-10 px-4 py-2 border-2 border-pink-200 focus:border-pink-400 bg-pink-50/60 rounded-lg shadow-sm focus:outline-none transition-all duration-200 text-gray-700 placeholder:text-pink-300 font-lexend text-base"
                            type="text"
                            id="search"
